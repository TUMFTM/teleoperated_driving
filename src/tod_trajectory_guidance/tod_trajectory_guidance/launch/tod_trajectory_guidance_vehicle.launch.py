...
def generate_launch_description():
    ...
    namespace_vehicle = '/vehicle/trajectory_guidance'

    trajectory_guidance_node = Node(
        package='tod_trajectory_guidance',
        executable='TrajectoryGuidanceNode',
        namespace=namespace_vehicle,
        name='TrajectoryGuidanceNode',
        output='screen',
        parameters=[
            node_param_path,
