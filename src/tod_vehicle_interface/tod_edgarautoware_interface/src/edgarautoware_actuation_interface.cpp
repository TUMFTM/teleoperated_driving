/**
 * @file edgarautoware_actuation_interface.cpp
...
ActuationInterface::ActuationInterface() : rclcpp::Node("edgarautoware_actuation_interface") 
{
    ...
    // topic parameters subscriptions
    //// edgar
    ...
    //// edgar autoware vehicle interface
    ...
    this->declare_parameter<std::string>("aw_hazard_lights_report_topic", "none");
    this->declare_parameter<std::string>("aw_turn_indicators_report_topic", "none");
    ...
    // topic parameters publisher
    this->declare_parameter<std::string>("aw_ackermann_control_command_topic", "none");
    this->declare_parameter<std::string>("aw_gear_command_topic", "none");
    this->declare_parameter<std::string>("aw_hazard_lights_command_topic", "none");
    this->declare_parameter<std::string>("aw_turn_indicators_command_topic", "none");
    this->declare_parameter<std::string>("aw_heartbeat_topic", "none");
...
void ActuationInterface::run()
{
    ...
    // Get topics names from parameters
    ...
    std::string aw_hazard_lights_report_topic = this->get_parameter("aw_hazard_lights_report_topic").as_string();
    std::string aw_turn_indicators_report_topic = this->get_parameter("aw_turn_indicators_report_topic").as_string();
    ...
    std::string aw_ackermann_control_command_topic = this->get_parameter("aw_ackermann_control_command_topic").as_string();
    std::string aw_gear_command_topic = this->get_parameter("aw_gear_command_topic").as_string();
    std::string aw_hazard_lights_command_topic = this->get_parameter("aw_hazard_lights_command_topic").as_string();
    std::string aw_turn_indicators_command_topic = this->get_parameter("aw_turn_indicators_command_topic").as_string();
    std::string aw_heartbeat_topic = this->get_parameter("aw_heartbeat_topic").as_string();
    ...
    if (edgar_gateway_states_topic != "none") {
        this->generic_actuation_interface_->add_subscriber<tum_edgar_can_msgs::msg::TUMEdgarGatewayStates>(
            ...
            [this](const tum_edgar_can_msgs::msg::TUMEdgarGatewayStates &msg) {
                this->edgar_gateway_states_handler(msg);
            });
    }
    ...
    this->generic_actuation_interface_->add_publisher<autoware_auto_control_msgs::msg::AckermannControlCommand>(
        aw_ackermann_control_command_topic,
        [this]() {
            return this->aw_ackermann_control_command_msg_builder();
        },
    ...
    this->generic_actuation_interface_->add_publisher<autoware_auto_vehicle_msgs::msg::GearCommand>(
        ...
        [this]() {
            return this->aw_gear_command_msg_builder();
        },
        {"SecondaryCtrl_Gear"},
        20);

    this->generic_actuation_interface_->add_publisher<autoware_auto_vehicle_msgs::msg::HazardLightsCommand>(
        aw_hazard_lights_command_topic,
        [this]() {
            return this->aw_hazard_lights_command_msg_builder();
        },
    ...
    this->generic_actuation_interface_->add_publisher<autoware_auto_vehicle_msgs::msg::TurnIndicatorsCommand>(
        aw_turn_indicators_command_topic,
        [this]() {
            return this->aw_turn_indicators_command_msg_builder();
        },
        {"SecondaryCtrl_Indicator"},
        50);
    
    this->generic_actuation_interface_->add_publisher<tier4_external_api_msgs::msg::Heartbeat>(
        aw_heartbeat_topic,
        [this]() {
            return this->aw_heartbeat_msg_builder();
        },
        { },
        50);
...
void ActuationInterface::edgar_gateway_states_handler(const tum_edgar_can_msgs::msg::TUMEdgarGatewayStates &msg)
{
...
void ActuationInterface::edgar_motion_handler(const tum_edgar_can_msgs::msg::TUMEdgarMotion &msg)
{
...
void ActuationInterface::aw_hazard_lights_report_handler(const autoware_auto_vehicle_msgs::msg::HazardLightsReport &msg)
{
...
void ActuationInterface::aw_turn_indicators_report_handler(const autoware_auto_vehicle_msgs::msg::TurnIndicatorsReport &msg)
{
    int8_t indicator;
...
{
    this->generic_actuation_interface_->update_attribute("SecondaryVehicleData_HeadLight", 
        static_cast<int8_t>((msg.report == tum_autoware_vehicle_msgs::msg::HeadLightReport::HEAD_LIGHT_AUTO || 
...
// Publisher - Message builder
autoware_auto_control_msgs::msg::AckermannControlCommand ActuationInterface::aw_ackermann_control_command_msg_builder()
{
...
autoware_auto_vehicle_msgs::msg::GearCommand ActuationInterface::aw_gear_command_msg_builder()
{
    ...
    RCLCPP_INFO(this->get_logger(), "gear");
...
autoware_auto_vehicle_msgs::msg::HazardLightsCommand ActuationInterface::aw_hazard_lights_command_msg_builder()
{
...
autoware_auto_vehicle_msgs::msg::TurnIndicatorsCommand ActuationInterface::aw_turn_indicators_command_msg_builder()
{
...
tier4_external_api_msgs::msg::Heartbeat ActuationInterface::aw_heartbeat_msg_builder()
{
