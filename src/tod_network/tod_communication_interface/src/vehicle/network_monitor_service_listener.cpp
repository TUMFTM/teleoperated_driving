/**
 * @file network_monitor_service_listener.cpp
...
int main(int argc, char** argv) {
    ...
    std::shared_ptr<tod_network::ServiceListener<tod_network_monitoring_msgs::srv::NetworkMonitorService>> network_monitor_service_listener;

    boost::asio::io_context io;

    if (protocol == "UDP") {  // UDP
        network_monitor_service_listener = std::make_shared<tod_network::ServiceListener<tod_network_monitoring_msgs::srv::NetworkMonitorService>>(
    ...
    rclcpp::spin(network_monitor_service_listener);
    rclcpp::shutdown();
