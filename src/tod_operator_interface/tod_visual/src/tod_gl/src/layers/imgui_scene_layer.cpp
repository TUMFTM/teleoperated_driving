...
ImGuiSceneLayer::ImGuiSceneLayer(std::shared_ptr<RosInterface> ros, std::shared_ptr<Scene> scene)
    : SceneLayer(ros, scene, "ImGuiSceneLayer") {}

void ImGuiSceneLayer::on_attach() {
    ...
    SceneApplication& app = SceneApplication::get();
...
void ImGuiSceneLayer::on_detach() {
    ImGui_ImplOpenGL3_Shutdown();
    ImGui_ImplGlfw_Shutdown();
    ImGui::DestroyContext();
}

void ImGuiSceneLayer::on_event(Event& e) {
    if (_block_events) {
        ImGuiIO& io = ImGui::GetIO();
...
void ImGuiSceneLayer::begin() {
    ImGui_ImplOpenGL3_NewFrame();
    ImGui_ImplGlfw_NewFrame();
    ImGui::NewFrame();
}

void ImGuiSceneLayer::end() {
    ImGuiIO& io = ImGui::GetIO();
    SceneApplication& app = SceneApplication::get();
...
void ImGuiSceneLayer::set_dark_theme_colors() {
...
uint32_t ImGuiSceneLayer::get_active_widget_ID() const {
    return GImGui->ActiveId;
}

GLuint ImGuiSceneLayer::load_texture(const std::string& imagePath) {
