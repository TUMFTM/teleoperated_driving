/**
 * @file secondary_control_component.hpp
 * @brief SecondaryVehicleCommands component that manages the subscription and the data for SecondaryControl topics for Secondary vehicle control commands going to the vehicle 
...
class SecondaryControlCommandComponent : public SubscribingComponent<tod_vehicle_msgs::msg::SecondaryControlCmd> {
  public:
    explicit SecondaryControlCommandComponent(std::shared_ptr<rclcpp::Node> sub_node)
      : SubscribingComponent(sub_node, "input/secondary_control_command"),
  ...
  private:
    void cb_message(const tod_vehicle_msgs::msg::SecondaryControlCmd::SharedPtr msg) override;
